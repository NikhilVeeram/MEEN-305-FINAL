...
\item Total evaluated designs: 540
\item Feasible designs found: 313
...
\section*{Best Design}
\begin{itemize}
\item Weight: 0.06614 lbf
\item Minimum factor of safety: 1.553
\item Excess FoS above target: 0.053
\item Governing minimum-FoS load case: Load Case 1 at $x=4.000$ in
\item Maximum deflection: 0.05775 in
...
\[W = \rho \int_0^L A(x)\,dx = 0.06614\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1532.7} = 1.553\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.05775\ \mathrm{in}, \qquad \max |\theta(x)| = 0.019443\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{574.8} = 4.141\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.02681\ \mathrm{in}, \qquad \max |\theta(x)| = 0.008859\ \mathrm{rad}\]
