...
- Weight: 0.03270 lbf
- Minimum factor of safety: 1.564
- Excess FoS above target: 0.064
- Governing minimum-FoS load case: Load Case 1 at x = 4.000 in
- Maximum deflection: 0.09030 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 1.564 | 4.000 | 0.09030 | 1521.5 |
| Load Case 2 | side | 3.000 | 2.500 | 3.691 | 2.490 | 0.05868 | 644.9 |
...
- $$b(x)=\begin{cases}0.3500 + (0.0000)x, & 0 \le x \le 4.0000\\0.3500 + (0.0968)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.7428 + (-0.0907)x, & 0 \le x \le 4.0000\\0.3800 + (0.0485)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.1199 + (0.0427)x, & 0 \le x \le 4.0000\\0.2909 + (-0.0144)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.03270\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1521.5 = 1.564$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.09030\ \text{in}$
- $\max |\theta(x)| = 0.030029\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/644.9 = 3.691$
- Governing location for this load case: $x = 2.490\ \text{in}$
- $\max |v(x)| = 0.05868\ \text{in}$
- $\max |\theta(x)| = 0.025279\ \text{rad}$
