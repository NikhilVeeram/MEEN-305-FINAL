...
- Total evaluated designs: 1940
- Feasible designs found: 579
...
- Weight: 0.09583 lbf
- Minimum factor of safety: 1.804
- Excess FoS above target: 0.304
- Governing minimum-FoS load case: Load Case 2 at x = 5.000 in
- Maximum deflection: 0.05265 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 17.728 | 4.000 | 0.00416 | 134.3 |
| Load Case 2 | side | 8.000 | 5.000 | 1.804 | 5.000 | 0.05265 | 1318.9 |
...
- $$b(x)=\begin{cases}0.7191 + (-0.0923)x, & 0 \le x \le 4.0000\\0.3500 + (0.0000)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.6910 + (0.1398)x, & 0 \le x \le 4.0000\\1.2500 + (-0.0397)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.0835 + (0.1295)x, & 0 \le x \le 4.0000\\0.6016 + (-0.0802)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.09583\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/134.3 = 17.728$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.00416\ \text{in}$
- $\max |\theta(x)| = 0.001728\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1318.9 = 1.804$
- Governing location for this load case: $x = 5.000\ \text{in}$
- $\max |v(x)| = 0.05265\ \text{in}$
- $\max |\theta(x)| = 0.023306\ \text{rad}$
