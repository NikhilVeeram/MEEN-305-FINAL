...
- Weight: 0.04946 lbf
- Minimum factor of safety: 1.670
- Excess FoS above target: 0.170
- Governing minimum-FoS load case: Load Case 1 at x = 4.000 in
- Maximum deflection: 0.04698 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 1.670 | 4.000 | 0.04698 | 1425.3 |
| Load Case 2 | side | 3.000 | 2.500 | 4.172 | 4.000 | 0.02499 | 570.5 |
...
- $$b(x)=\begin{cases}0.9323 + (-0.1456)x, & 0 \le x \le 4.0000\\0.3500 + (0.2081)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}1.3000 + (-0.2300)x, & 0 \le x \le 4.0000\\0.3800 + (0.1990)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.7817 + (-0.1476)x, & 0 \le x \le 4.0000\\0.1914 + (0.1464)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.04946\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1425.3 = 1.670$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.04698\ \text{in}$
- $\max |\theta(x)| = 0.013956\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/570.5 = 4.172$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.02499\ \text{in}$
- $\max |\theta(x)| = 0.008266\ \text{rad}$
