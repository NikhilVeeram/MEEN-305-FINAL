...
- Weight: 0.02599 lbf
- Minimum factor of safety: 1.647
- Excess FoS above target: 0.147
- Governing minimum-FoS load case: Load Case 2 at x = 5.500 in
- Maximum deflection: 0.17326 in
- Uniformity score toward FoS target (0 is best): 0.313992
- Symmetry score (0 is best): 0.000000
- Smoothness score (0 is best): 0.002028
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 5.671 | 4.500 | 0.02143 | 705.3 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.647 | 5.500 | 0.17326 | 2428.1 |
...
- $$b(x)=\begin{cases}0.2306 + (0.0083)x, & 0 \le x \le 4.5000\\0.2680 + (-0.0083)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.7451 + (-0.0161)x, & 0 \le x \le 4.5000\\0.6727 + (0.0161)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$r(x)=\begin{cases}0.6968 + (-0.0403)x, & 0 \le x \le 4.5000\\0.5154 + (0.0403)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $E_{eff} = E \times k_{orientation} \times k_{infill} = 500000.0 \times 1.000 \times 1.000 = 500000.0\ \text{psi}$
- $\sigma_{allow,eff} = \sigma_{allow} \times k_{orientation} \times k_{infill} = 4000.0 \times 1.000 \times 1.000 = 4000.0\ \text{psi}$
- Support positions: $x_A = 0.500\ \text{in}$, $x_B = 8.500\ \text{in}$
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.02599\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 4000.0/705.3 = 5.671$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.02143\ \text{in}$
- $\max |\theta(x)| = 0.007974\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 4000.0/2428.1 = 1.647$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.17326\ \text{in}$
- $\max |\theta(x)| = 0.073594\ \text{rad}$
