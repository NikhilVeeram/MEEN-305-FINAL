...
\item Feasible designs found: 822
...
\item Random seed: 2431
\end{itemize}

\section*{Best Design}
\begin{itemize}
\item Weight: 0.02116 lbf
\item Minimum factor of safety: 1.676
\item Excess FoS above target: 0.176
\item Governing minimum-FoS load case: Load Case 2 at $x=5.500$ in
\item Maximum deflection: 0.11112 in
\item Uniformity score toward FoS target (0 is best): 0.291303
\item Symmetry score (0 is best): 0.014145
\item Smoothness score (0 is best): 0.043182
...
\[W = \rho \int_0^{L_{total}} A(x)\,dx = 0.02116\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{742.1} = 3.207\]
\[x_{FoS,min} = 4.500\ \mathrm{in}\]
\[\max |v(x)| = 0.04917\ \mathrm{in}, \qquad \max |\theta(x)| = 0.019525\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1420.0} = 1.676\]
\[x_{FoS,min} = 5.500\ \mathrm{in}\]
\[\max |v(x)| = 0.11112\ \mathrm{in}, \qquad \max |\theta(x)| = 0.055798\ \mathrm{rad}\]
