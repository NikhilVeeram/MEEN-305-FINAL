...
- Total evaluated designs: 1600
- Feasible designs found: 1057
...
- Maximum deflection: 0.16349 in
- Uniformity score toward FoS target (0 is best): 0.096234
- Symmetry score (0 is best): 0.107783
- Smoothness score (0 is best): 0.008884
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 4.920 | 4.500 | 0.02656 | 483.8 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.520 | 5.500 | 0.16349 | 1565.4 |
...
- $$b(x)=\begin{cases}0.4037 + (-0.0157)x, & 0 \le x \le 4.5000\\0.3329 + (-0.0206)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.4800 + (0.0673)x, & 0 \le x \le 4.5000\\0.7829 + (-0.0271)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.04297\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/483.8 = 4.920$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.02656\ \text{in}$
- $\max |\theta(x)| = 0.011037\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1565.4 = 1.520$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.16349\ \text{in}$
- $\max |\theta(x)| = 0.076227\ \text{rad}$
