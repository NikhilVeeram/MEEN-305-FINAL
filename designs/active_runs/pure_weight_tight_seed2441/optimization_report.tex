...
\item Total evaluated designs: 3300
\item Feasible designs found: 1370
...
\item Random seed: 2441
\end{itemize}

\section*{Best Design}
\begin{itemize}
\item Weight: 0.01989 lbf
\item Minimum factor of safety: 1.558
\item Excess FoS above target: 0.058
\item Governing minimum-FoS load case: Load Case 2 at $x=8.500$ in
\item Maximum deflection: 0.10281 in
\item Uniformity score toward FoS target (0 is best): 0.314983
\item Symmetry score (0 is best): 0.000000
\item Smoothness score (0 is best): 0.013162
...
\[W = \rho \int_0^{L_{total}} A(x)\,dx = 0.01989\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{711.8} = 3.344\]
\[x_{FoS,min} = 4.500\ \mathrm{in}\]
\[\max |v(x)| = 0.03842\ \mathrm{in}, \qquad \max |\theta(x)| = 0.014619\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1528.1} = 1.558\]
\[x_{FoS,min} = 8.500\ \mathrm{in}\]
\[\max |v(x)| = 0.10281\ \mathrm{in}, \qquad \max |\theta(x)| = 0.046908\ \mathrm{rad}\]
