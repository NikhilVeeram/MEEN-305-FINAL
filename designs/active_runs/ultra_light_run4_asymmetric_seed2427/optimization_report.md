...
- Weight: 0.02225 lbf
- Minimum factor of safety: 1.687
- Excess FoS above target: 0.187
- Governing minimum-FoS load case: Load Case 1 at x = 4.500 in
- Maximum deflection: 0.15763 in
- Uniformity score toward FoS target (0 is best): 0.245114
- Symmetry score (0 is best): 0.192914
- Smoothness score (0 is best): 0.075101
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.02225\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1410.5 = 1.687$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.15763\ \text{in}$
- $\max |\theta(x)| = 0.063390\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1331.8 = 1.787$
- Governing location for this load case: $x = 8.500\ \text{in}$
- $\max |v(x)| = 0.07752\ \text{in}$
- $\max |\theta(x)| = 0.039814\ \text{rad}$
