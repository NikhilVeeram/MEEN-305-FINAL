...
\item Feasible designs found: 1434
...
\item Random seed: 2440
\end{itemize}

\section*{Best Design}
\begin{itemize}
\item Weight: 0.01967 lbf
\item Minimum factor of safety: 1.631
\item Excess FoS above target: 0.131
\item Governing minimum-FoS load case: Load Case 2 at $x=5.500$ in
\item Maximum deflection: 0.09100 in
\item Uniformity score toward FoS target (0 is best): 0.323573
\item Symmetry score (0 is best): 0.000001
\item Smoothness score (0 is best): 0.027209
...
\[W = \rho \int_0^{L_{total}} A(x)\,dx = 0.01967\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{628.6} = 3.786\]
\[x_{FoS,min} = 4.500\ \mathrm{in}\]
\[\max |v(x)| = 0.03664\ \mathrm{in}, \qquad \max |\theta(x)| = 0.015609\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1459.2} = 1.631\]
\[x_{FoS,min} = 5.500\ \mathrm{in}\]
\[\max |v(x)| = 0.09100\ \mathrm{in}, \qquad \max |\theta(x)| = 0.043954\ \mathrm{rad}\]
