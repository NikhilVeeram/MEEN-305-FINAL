...
- Total evaluated designs: 1760
- Feasible designs found: 745
...
- Maximum deflection: 0.23712 in
- Uniformity score toward FoS target (0 is best): 0.177687
- Symmetry score (0 is best): 0.138728
- Smoothness score (0 is best): 0.011773
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 7.450 | 4.500 | 0.01191 | 319.4 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.502 | 5.500 | 0.23712 | 1584.7 |
...
- $$b(x)=\begin{cases}0.2040 + (0.0063)x, & 0 \le x \le 4.5000\\0.2324 + (0.0267)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.7402 + (0.0911)x, & 0 \le x \le 4.5000\\1.1500 + (-0.0545)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$r(x)=\begin{cases}0.3128 + (-0.0395)x, & 0 \le x \le 4.5000\\0.1352 + (-0.0090)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.04462\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/319.4 = 7.450$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.01191\ \text{in}$
- $\max |\theta(x)| = 0.005118\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1584.7 = 1.502$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.23712\ \text{in}$
- $\max |\theta(x)| = 0.094941\ \text{rad}$
