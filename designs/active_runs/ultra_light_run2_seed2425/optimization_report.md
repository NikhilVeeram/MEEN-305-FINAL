...
- Weight: 0.01957 lbf
- Minimum factor of safety: 1.707
- Excess FoS above target: 0.207
- Governing minimum-FoS load case: Load Case 2 at x = 5.500 in
- Maximum deflection: 0.08948 in
- Uniformity score toward FoS target (0 is best): 0.324115
- Symmetry score (0 is best): 0.000001
- Smoothness score (0 is best): 0.031899
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 4.169 | 4.500 | 0.03370 | 570.9 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.707 | 5.500 | 0.08948 | 1394.6 |
...
- $$b(x)=\begin{cases}0.2851 + (0.0591)x, & 0 \le x \le 4.5000\\0.5509 + (-0.0591)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.4714 + (0.0681)x, & 0 \le x \le 4.5000\\0.7778 + (-0.0681)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$r(x)=\begin{cases}0.6290 + (0.0123)x, & 0 \le x \le 4.5000\\0.6845 + (-0.0123)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.01957\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/570.9 = 4.169$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.03370\ \text{in}$
- $\max |\theta(x)| = 0.014466\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1394.6 = 1.707$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.08948\ \text{in}$
- $\max |\theta(x)| = 0.044272\ \text{rad}$
