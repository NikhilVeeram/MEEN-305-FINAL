...
- Total evaluated designs: 2020
- Feasible designs found: 865
...
- Weight: 0.02811 lbf
- Minimum factor of safety: 1.582
- Excess FoS above target: 0.082
- Governing minimum-FoS load case: Load Case 2 at x = 5.500 in
- Maximum deflection: 0.15109 in
- Uniformity score toward FoS target (0 is best): 0.165809
- Symmetry score (0 is best): 0.015507
- Smoothness score (0 is best): 0.037930
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 4.482 | 4.500 | 0.03692 | 531.0 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.582 | 5.500 | 0.15109 | 1504.7 |
...
- $$b(x)=\begin{cases}0.2217 + (0.0463)x, & 0 \le x \le 4.5000\\0.4303 + (-0.0529)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.4542 + (0.0631)x, & 0 \le x \le 4.5000\\0.7382 + (-0.0641)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$r(x)=\begin{cases}0.3063 + (-0.0681)x, & 0 \le x \le 4.5000\\0.0000 + (0.1111)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.02811\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/531.0 = 4.482$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.03692\ \text{in}$
- $\max |\theta(x)| = 0.016158\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1504.7 = 1.582$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.15109\ \text{in}$
- $\max |\theta(x)| = 0.079063\ \text{rad}$
