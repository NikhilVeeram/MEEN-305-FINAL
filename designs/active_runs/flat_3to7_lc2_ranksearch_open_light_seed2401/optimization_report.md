...
- Weight: 0.02862 lbf
- Minimum factor of safety: 1.509
- Excess FoS above target: 0.009
- Governing minimum-FoS load case: Load Case 2 at x = 5.500 in
- Maximum deflection: 0.15968 in
- Uniformity score toward FoS target (0 is best): 0.064753
- Symmetry score (0 is best): 0.267943
- Smoothness score (0 is best): 0.012143
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.02862\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/552.2 = 4.310$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.03193\ \text{in}$
- $\max |\theta(x)| = 0.014505\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1577.2 = 1.509$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.15968\ \text{in}$
- $\max |\theta(x)| = 0.069586\ \text{rad}$
