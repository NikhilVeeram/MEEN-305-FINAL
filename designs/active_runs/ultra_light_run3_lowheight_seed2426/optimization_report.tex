...
\item Feasible designs found: 551
...
\item Random seed: 2426
\end{itemize}

\section*{Best Design}
\begin{itemize}
\item Weight: 0.02482 lbf
...
\item Maximum deflection: 0.13723 in
\item Uniformity score toward FoS target (0 is best): 0.254098
\item Symmetry score (0 is best): 0.000002
\item Smoothness score (0 is best): 0.055617
...
\[W = \rho \int_0^{L_{total}} A(x)\,dx = 0.02482\ \mathrm{lbf}\]
...
\[x_{FoS,min} = 5.130\ \mathrm{in}\]
\[\max |v(x)| = 0.09135\ \mathrm{in}, \qquad \max |\theta(x)| = 0.041994\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1565.3} = 1.520\]
\[x_{FoS,min} = 5.500\ \mathrm{in}\]
\[\max |v(x)| = 0.13723\ \mathrm{in}, \qquad \max |\theta(x)| = 0.073605\ \mathrm{rad}\]
