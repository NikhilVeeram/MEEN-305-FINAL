...
- Total evaluated designs: 1
- Feasible designs found: 1
...
- Weight: 0.02926 lbf
- Minimum factor of safety: 1.501
- Excess FoS above target: 0.001
- Governing minimum-FoS load case: Load Case 2 at x = 8.500 in
- Maximum deflection: 0.14255 in
- Uniformity score toward FoS target (0 is best): 0.174844
- Symmetry score (0 is best): 0.044296
- Smoothness score (0 is best): 0.026640
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 3.875 | 4.500 | 0.03388 | 614.1 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.501 | 8.500 | 0.14255 | 1585.9 |
...
- $$b(x)=\begin{cases}0.2217 + (0.0463)x, & 0 \le x \le 4.5000\\0.4300 + (-0.0511)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.6671 + (0.0036)x, & 0 \le x \le 4.5000\\0.6834 + (0.0217)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$r(x)=\begin{cases}0.3060 + (-0.0680)x, & 0 \le x \le 4.5000\\0.0000 + (0.1389)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.02926\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/614.1 = 3.875$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.03388\ \text{in}$
- $\max |\theta(x)| = 0.013369\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1585.9 = 1.501$
- Governing location for this load case: $x = 8.500\ \text{in}$
- $\max |v(x)| = 0.14255\ \text{in}$
- $\max |\theta(x)| = 0.068557\ \text{rad}$
