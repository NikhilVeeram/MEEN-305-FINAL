...
\item Feasible designs found: 681
...
\item Random seed: 6606
\end{itemize}

\section*{Best Design}
\begin{itemize}
\item Weight: 0.03752 lbf
\item Minimum factor of safety: 1.526
\item Excess FoS above target: 0.026
\item Governing minimum-FoS load case: Load Case 2 at $x=5.000$ in
\item Maximum deflection: 0.12629 in
\item Uniformity score toward FoS target (0 is best): 0.173245
\item Symmetry score (0 is best): 0.000000
\item Smoothness score (0 is best): 0.000824
...
\[W = \rho \int_0^L A(x)\,dx = 0.03752\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1256.5} = 1.894\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.11880\ \mathrm{in}, \qquad \max |\theta(x)| = 0.043505\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1559.3} = 1.526\]
\[x_{FoS,min} = 5.000\ \mathrm{in}\]
\[\max |v(x)| = 0.12629\ \mathrm{in}, \qquad \max |\theta(x)| = 0.052049\ \mathrm{rad}\]
