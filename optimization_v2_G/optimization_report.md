...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 1.551 | 4.000 | 0.08463 | 1534.3 |
| Load Case 2 | side | 3.000 | 2.500 | 3.624 | 2.490 | 0.06085 | 656.7 |
...
- $$r(x)=\begin{cases}0.6868 + (-0.0724)x, & 0 \le x \le 4.0000\\0.3971 + (0.0080)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.02690\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1534.3 = 1.551$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.08463\ \text{in}$
- $\max |\theta(x)| = 0.027657\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/656.7 = 3.624$
- Governing location for this load case: $x = 2.490\ \text{in}$
- $\max |v(x)| = 0.06085\ \text{in}$
- $\max |\theta(x)| = 0.025524\ \text{rad}$
