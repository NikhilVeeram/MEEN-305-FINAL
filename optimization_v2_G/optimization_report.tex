...
\item Feasible designs found: 713
...
\item Maximum deflection: 0.08463 in
...
\[W = \rho \int_0^L A(x)\,dx = 0.02690\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1534.3} = 1.551\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.08463\ \mathrm{in}, \qquad \max |\theta(x)| = 0.027657\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{656.7} = 3.624\]
\[x_{FoS,min} = 2.490\ \mathrm{in}\]
\[\max |v(x)| = 0.06085\ \mathrm{in}, \qquad \max |\theta(x)| = 0.025524\ \mathrm{rad}\]
