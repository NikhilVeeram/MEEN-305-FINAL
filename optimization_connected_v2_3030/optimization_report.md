...
- Weight: 0.03643 lbf
- Minimum factor of safety: 1.591
- Excess FoS above target: 0.091
- Governing minimum-FoS load case: Load Case 2 at x = 5.000 in
- Maximum deflection: 0.14085 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 3.722 | 4.000 | 0.03762 | 639.4 |
| Load Case 2 | side | 8.000 | 5.000 | 1.591 | 5.000 | 0.14085 | 1496.0 |
...
- $$b(x)=\begin{cases}0.3500 + (0.0003)x, & 0 \le x \le 4.0000\\0.3513 + (-0.0003)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.6940 + (-0.0275)x, & 0 \le x \le 4.0000\\0.5839 + (-0.0082)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.4425 + (-0.0346)x, & 0 \le x \le 4.0000\\0.3043 + (0.0384)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.03643\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/639.4 = 3.722$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.03762\ \text{in}$
- $\max |\theta(x)| = 0.014684\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1496.0 = 1.591$
- Governing location for this load case: $x = 5.000\ \text{in}$
- $\max |v(x)| = 0.14085\ \text{in}$
- $\max |\theta(x)| = 0.059125\ \text{rad}$
