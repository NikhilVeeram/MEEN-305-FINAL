...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 2.398 | 4.000 | 0.03606 | 992.5 |
| Load Case 2 | side | 8.000 | 5.000 | 1.544 | 4.000 | 0.08910 | 1541.1 |
...
- $$b(x)=\begin{cases}0.3968 + (-0.0117)x, & 0 \le x \le 4.0000\\0.3500 + (0.2695)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}1.2739 + (-0.1939)x, & 0 \le x \le 4.0000\\0.4983 + (0.0845)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.8133 + (-0.1078)x, & 0 \le x \le 4.0000\\0.3823 + (0.0513)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.03929\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/992.5 = 2.398$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.03606\ \text{in}$
- $\max |\theta(x)| = 0.011450\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1541.1 = 1.544$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.08910\ \text{in}$
- $\max |\theta(x)| = 0.032367\ \text{rad}$
