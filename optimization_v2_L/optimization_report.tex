...
\item Feasible designs found: 700
...
\item Random seed: 55555
\end{itemize}

\section*{Best Design}
\begin{itemize}
\item Weight: 0.04302 lbf
\item Minimum factor of safety: 1.530
\item Excess FoS above target: 0.030
\item Governing minimum-FoS load case: Load Case 1 at $x=4.000$ in
\item Maximum deflection: 0.07507 in
...
\[W = \rho \int_0^L A(x)\,dx = 0.04302\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1555.3} = 1.530\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.07507\ \mathrm{in}, \qquad \max |\theta(x)| = 0.024839\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{619.5} = 3.842\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.03281\ \mathrm{in}, \qquad \max |\theta(x)| = 0.011703\ \mathrm{rad}\]
