...
- Weight: 0.03818 lbf
- Minimum factor of safety: 1.547
- Excess FoS above target: 0.047
- Governing minimum-FoS load case: Load Case 2 at x = 4.000 in
- Maximum deflection: 0.07219 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 3.739 | 4.000 | 0.01705 | 636.5 |
| Load Case 2 | side | 8.000 | 5.000 | 1.547 | 4.000 | 0.07219 | 1538.3 |
...
- $$b(x)=\begin{cases}0.3500 + (0.0000)x, & 0 \le x \le 4.0000\\0.3500 + (0.2444)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.9903 + (-0.0421)x, & 0 \le x \le 4.0000\\0.8221 + (0.1138)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.8700 + (-0.0071)x, & 0 \le x \le 4.0000\\0.8417 + (-0.1584)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.03818\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/636.5 = 3.739$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.01705\ \text{in}$
- $\max |\theta(x)| = 0.006639\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1538.3 = 1.547$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.07219\ \text{in}$
- $\max |\theta(x)| = 0.029186\ \text{rad}$
