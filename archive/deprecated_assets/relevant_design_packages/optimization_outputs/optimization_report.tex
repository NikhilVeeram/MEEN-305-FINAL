...
\item Total evaluated designs: 456
\item Feasible designs found: 292
...
\section*{Best Design}
\begin{itemize}
\item Weight: 0.04117 lbf
\item Minimum factor of safety: 1.584
\item Excess FoS above target: 0.084
\item Governing minimum-FoS load case: Load Case 1 at $x=4.000$ in
\item Maximum deflection: 0.08054 in
...
\[W = \rho \int_0^L A(x)\,dx = 0.04117\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1502.7} = 1.584\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.08054\ \mathrm{in}, \qquad \max |\theta(x)| = 0.032309\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{606.9} = 3.921\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.04253\ \mathrm{in}, \qquad \max |\theta(x)| = 0.016486\ \mathrm{rad}\]
