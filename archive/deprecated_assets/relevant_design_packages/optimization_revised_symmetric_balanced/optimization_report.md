...
- Maximum allowed deflection: 0.11000 in
- Random seed: 2606

## Best Design

- Weight: 0.02649 lbf
- Minimum factor of safety: 1.863
- Excess FoS above target: 0.363
- Governing minimum-FoS load case: Load Case 2 at x = 5.000 in
- Maximum deflection: 0.09424 in
- Symmetry score (0 is best): 0.000000
- Smoothness score (0 is best): 0.001651
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.965 | 4.000 | 0.02161 | 479.3 |
| Load Case 2 | side | 8.000 | 5.000 | 1.863 | 5.000 | 0.09424 | 1277.5 |
...
- $$b(x)=\begin{cases}0.3500 + (0.0153)x, & 0 \le x \le 4.0000\\0.4111 + (-0.0153)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.7854 + (-0.0021)x, & 0 \le x \le 4.0000\\0.7772 + (0.0021)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.6765 + (-0.0113)x, & 0 \le x \le 4.0000\\0.6312 + (0.0113)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.02649\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/479.3 = 4.965$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.02161\ \text{in}$
- $\max |\theta(x)| = 0.008179\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1277.5 = 1.863$
- Governing location for this load case: $x = 5.000\ \text{in}$
- $\max |v(x)| = 0.09424\ \text{in}$
- $\max |\theta(x)| = 0.040516\ \text{rad}$
