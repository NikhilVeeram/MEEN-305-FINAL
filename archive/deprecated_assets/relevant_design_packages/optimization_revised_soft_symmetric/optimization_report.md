...
- Weight: 0.03312 lbf
- Minimum factor of safety: 1.639
- Excess FoS above target: 0.139
- Governing minimum-FoS load case: Load Case 2 at x = 4.000 in
- Maximum deflection: 0.10926 in
- Symmetry score (0 is best): 0.042791
- Smoothness score (0 is best): 0.023515
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 2.080 | 4.000 | 0.06630 | 1144.5 |
| Load Case 2 | side | 8.000 | 5.000 | 1.639 | 4.000 | 0.10926 | 1452.4 |
...
- $$b(x)=\begin{cases}0.5201 + (-0.0315)x, & 0 \le x \le 4.0000\\0.3940 + (0.0623)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.7045 + (-0.0698)x, & 0 \le x \le 4.0000\\0.4252 + (0.0474)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.5518 + (-0.0898)x, & 0 \le x \le 4.0000\\0.1926 + (0.0417)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.03312\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1144.5 = 2.080$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.06630\ \text{in}$
- $\max |\theta(x)| = 0.022616\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1452.4 = 1.639$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.10926\ \text{in}$
- $\max |\theta(x)| = 0.039107\ \text{rad}$
