...
- $W = \rho \int_0^L A(x)\,dx = 0.02631\ \text{lbf}$
...
- $\max |v(x)| = 0.08488\ \text{in}$
- $\max |\theta(x)| = 0.027769\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/665.1 = 3.579$
- Governing location for this load case: $x = 2.490\ \text{in}$
- $\max |v(x)| = 0.06095\ \text{in}$
- $\max |\theta(x)| = 0.025575\ \text{rad}$
