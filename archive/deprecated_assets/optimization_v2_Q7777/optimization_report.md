...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 3.956 | 4.000 | 0.02538 | 601.6 |
| Load Case 2 | side | 8.000 | 5.000 | 1.522 | 5.000 | 0.11608 | 1563.8 |
...
- $$b(x)=\begin{cases}0.8230 + (-0.1183)x, & 0 \le x \le 4.0000\\0.3500 + (0.0000)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.9594 + (-0.0582)x, & 0 \le x \le 4.0000\\0.7266 + (-0.0302)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.3342 + (0.0790)x, & 0 \le x \le 4.0000\\0.6504 + (-0.0936)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.03454\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/601.6 = 3.956$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.02538\ \text{in}$
- $\max |\theta(x)| = 0.010536\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1563.8 = 1.522$
- Governing location for this load case: $x = 5.000\ \text{in}$
- $\max |v(x)| = 0.11608\ \text{in}$
- $\max |\theta(x)| = 0.052181\ \text{rad}$
