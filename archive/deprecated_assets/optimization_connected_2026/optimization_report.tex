...
\item Feasible designs found: 429
...
\item Random seed: 2026
\end{itemize}

\section*{Best Design}
\begin{itemize}
\item Weight: 0.05103 lbf
\item Minimum factor of safety: 2.288
\item Excess FoS above target: 0.788
\item Governing minimum-FoS load case: Load Case 2 at $x=4.000$ in
\item Maximum deflection: 0.07570 in
...
\[W = \rho \int_0^L A(x)\,dx = 0.05103\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{696.8} = 3.416\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.02977\ \mathrm{in}, \qquad \max |\theta(x)| = 0.010006\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1040.3} = 2.288\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.07570\ \mathrm{in}, \qquad \max |\theta(x)| = 0.027437\ \mathrm{rad}\]
