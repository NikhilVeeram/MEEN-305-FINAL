...
- Weight: 0.03266 lbf
- Minimum factor of safety: 1.587
- Excess FoS above target: 0.087
- Governing minimum-FoS load case: Load Case 1 at x = 4.000 in
- Maximum deflection: 0.09411 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 1.587 | 4.000 | 0.09411 | 1500.1 |
| Load Case 2 | side | 3.000 | 2.500 | 3.280 | 2.490 | 0.06045 | 725.6 |
...
- $$b(x)=\begin{cases}0.3500 + (0.0000)x, & 0 \le x \le 4.0000\\0.3500 + (0.1456)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.5613 + (-0.0444)x, & 0 \le x \le 4.0000\\0.3838 + (0.0584)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.0938 + (0.0568)x, & 0 \le x \le 4.0000\\0.3211 + (0.0243)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.03266\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1500.1 = 1.587$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.09411\ \text{in}$
- $\max |\theta(x)| = 0.033855\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/725.6 = 3.280$
- Governing location for this load case: $x = 2.490\ \text{in}$
- $\max |v(x)| = 0.06045\ \text{in}$
- $\max |\theta(x)| = 0.027316\ \text{rad}$
