...
\item Feasible designs found: 60
...
\item Maximum deflection: 0.13156 in
\item Symmetry score (0 is best): 0.000000
\item Smoothness score (0 is best): 0.003744
...
\[W = \rho \int_0^L A(x)\,dx = 0.03015\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{986.1} = 2.413\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.07096\ \mathrm{in}, \qquad \max |\theta(x)| = 0.026282\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1583.2} = 1.503\]
\[x_{FoS,min} = 5.000\ \mathrm{in}\]
\[\max |v(x)| = 0.13156\ \mathrm{in}, \qquad \max |\theta(x)| = 0.052851\ \mathrm{rad}\]
