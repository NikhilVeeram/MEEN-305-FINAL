...
- Weight: 0.03968 lbf
- Minimum factor of safety: 2.051
- Excess FoS above target: 0.551
- Governing minimum-FoS load case: Load Case 2 at x = 5.000 in
- Maximum deflection: 0.09771 in
...
- $W = \rho \int_0^L A(x)\,dx = 0.03968\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/471.4 = 5.049$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.02899\ \text{in}$
- $\max |\theta(x)| = 0.012448\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1160.5 = 2.051$
- Governing location for this load case: $x = 5.000\ \text{in}$
- $\max |v(x)| = 0.09771\ \text{in}$
- $\max |\theta(x)| = 0.042322\ \text{rad}$
