...
- Weight: 0.03018 lbf
- Minimum factor of safety: 1.634
- Excess FoS above target: 0.134
- Governing minimum-FoS load case: Load Case 2 at x = 5.000 in
- Maximum deflection: 0.12226 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 2.798 | 4.000 | 0.04145 | 850.7 |
| Load Case 2 | side | 8.000 | 5.000 | 1.634 | 5.000 | 0.12226 | 1457.0 |
...
- $$b(x)=\begin{cases}0.4458 + (-0.0239)x, & 0 \le x \le 4.0000\\0.3502 + (0.0555)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}1.0509 + (-0.1229)x, & 0 \le x \le 4.0000\\0.5594 + (-0.0073)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.6214 + (-0.0240)x, & 0 \le x \le 4.0000\\0.5254 + (-0.0571)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.03018\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/850.7 = 2.798$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.04145\ \text{in}$
- $\max |\theta(x)| = 0.015984\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1457.0 = 1.634$
- Governing location for this load case: $x = 5.000\ \text{in}$
- $\max |v(x)| = 0.12226\ \text{in}$
- $\max |\theta(x)| = 0.045448\ \text{rad}$
