...
- Weight: 0.02939 lbf
- Minimum factor of safety: 1.588
- Excess FoS above target: 0.088
- Governing minimum-FoS load case: Load Case 1 at x = 4.000 in
- Maximum deflection: 0.11822 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 1.588 | 4.000 | 0.11822 | 1498.8 |
| Load Case 2 | side | 3.000 | 2.500 | 2.922 | 2.490 | 0.07100 | 814.5 |
...
- $$b(x)=\begin{cases}0.3500 + (0.0008)x, & 0 \le x \le 4.0000\\0.3532 + (0.0433)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.3993 + (-0.0048)x, & 0 \le x \le 4.0000\\0.3800 + (0.0468)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.3310 + (-0.0751)x, & 0 \le x \le 4.0000\\0.0305 + (-0.0076)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.02939\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1498.8 = 1.588$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.11822\ \text{in}$
- $\max |\theta(x)| = 0.046017\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/814.5 = 2.922$
- Governing location for this load case: $x = 2.490\ \text{in}$
- $\max |v(x)| = 0.07100\ \text{in}$
- $\max |\theta(x)| = 0.032354\ \text{rad}$
