...
- Weight: 0.04589 lbf
- Minimum factor of safety: 1.500
- Excess FoS above target: 0.000
- Governing minimum-FoS load case: Load Case 2 at x = 4.000 in
- Maximum deflection: 0.08176 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 1.873 | 4.000 | 0.06613 | 1270.4 |
| Load Case 2 | side | 8.000 | 5.000 | 1.500 | 4.000 | 0.08176 | 1586.2 |
...
- $$b(x)=\begin{cases}1.5904 + (-0.3016)x, & 0 \le x \le 4.0000\\0.3842 + (0.1018)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.7678 + (-0.0905)x, & 0 \le x \le 4.0000\\0.4058 + (0.0182)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.3868 + (0.0531)x, & 0 \le x \le 4.0000\\0.5993 + (-0.0420)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.04589\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1270.4 = 1.873$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.06613\ \text{in}$
- $\max |\theta(x)| = 0.024156\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1586.2 = 1.500$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.08176\ \text{in}$
- $\max |\theta(x)| = 0.030120\ \text{rad}$
