...
- Weight: 0.05057 lbf
- Minimum factor of safety: 3.157
- Excess FoS above target: 1.657
- Governing minimum-FoS load case: Load Case 1 at x = 4.000 in
- Maximum deflection: 0.02303 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 3.157 | 4.000 | 0.02303 | 754.0 |
| Load Case 2 | side | 3.000 | 2.500 | 7.360 | 4.000 | 0.01260 | 323.4 |
...
- $$b(x)=\begin{cases}1.0994 + (-0.1623)x, & 0 \le x \le 4.0000\\0.4500 + (0.2453)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}1.3875 + (-0.2094)x, & 0 \le x \le 4.0000\\0.5500 + (0.1020)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.6304 + (0.0035)x, & 0 \le x \le 4.0000\\0.6442 + (-0.0651)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.05057\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/754.0 = 3.157$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.02303\ \text{in}$
- $\max |\theta(x)| = 0.007449\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/323.4 = 7.360$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.01260\ \text{in}$
- $\max |\theta(x)| = 0.004326\ \text{rad}$
