...
- Total evaluated designs: 1300
- Feasible designs found: 682
...
- Weight: 0.03979 lbf
- Minimum factor of safety: 1.522
- Excess FoS above target: 0.022
- Governing minimum-FoS load case: Load Case 2 at x = 4.000 in
- Maximum deflection: 0.07112 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 2.040 | 4.000 | 0.05189 | 1166.6 |
| Load Case 2 | side | 8.000 | 5.000 | 1.522 | 4.000 | 0.07112 | 1564.1 |
...
- $$b(x)=\begin{cases}1.0590 + (-0.1701)x, & 0 \le x \le 4.0000\\0.3787 + (0.1994)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.6673 + (-0.0558)x, & 0 \le x \le 4.0000\\0.4440 + (0.0845)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.7041 + (-0.0276)x, & 0 \le x \le 4.0000\\0.5938 + (0.0049)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.03979\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1166.6 = 2.040$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.05189\ \text{in}$
- $\max |\theta(x)| = 0.017226\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1564.1 = 1.522$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.07112\ \text{in}$
- $\max |\theta(x)| = 0.022703\ \text{rad}$
