...
- Weight: 0.04215 lbf
- Minimum factor of safety: 1.551
- Excess FoS above target: 0.051
- Governing minimum-FoS load case: Load Case 2 at x = 4.000 in
- Maximum deflection: 0.11218 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 2.307 | 4.000 | 0.05582 | 1031.5 |
| Load Case 2 | side | 8.000 | 5.000 | 1.551 | 4.000 | 0.11218 | 1534.9 |
...
- $$b(x)=\begin{cases}0.7068 + (-0.0892)x, & 0 \le x \le 4.0000\\0.3500 + (0.0690)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.5947 + (-0.0328)x, & 0 \le x \le 4.0000\\0.4633 + (0.0555)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.4562 + (-0.1097)x, & 0 \le x \le 4.0000\\0.0176 + (-0.0044)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.04215\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1031.5 = 2.307$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.05582\ \text{in}$
- $\max |\theta(x)| = 0.019223\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1534.9 = 1.551$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.11218\ \text{in}$
- $\max |\theta(x)| = 0.040035\ \text{rad}$
