...
- Weight: 0.04815 lbf
- Minimum factor of safety: 3.289
- Excess FoS above target: 1.789
- Governing minimum-FoS load case: Load Case 1 at x = 4.000 in
- Maximum deflection: 0.02037 in
...
- $W = \rho \int_0^L A(x)\,dx = 0.04815\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/723.6 = 3.289$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.02037\ \text{in}$
- $\max |\theta(x)| = 0.006481\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/300.0 = 7.933$
- Governing location for this load case: $x = 2.490\ \text{in}$
- $\max |v(x)| = 0.01728\ \text{in}$
- $\max |\theta(x)| = 0.007329\ \text{rad}$
