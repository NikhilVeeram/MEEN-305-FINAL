...
\item Feasible designs found: 804
...
\item Random seed: 31415
\end{itemize}

\section*{Best Design}
\begin{itemize}
\item Weight: 0.04285 lbf
\item Minimum factor of safety: 1.550
\item Excess FoS above target: 0.050
\item Governing minimum-FoS load case: Load Case 1 at $x=4.000$ in
\item Maximum deflection: 0.06029 in
...
\[W = \rho \int_0^L A(x)\,dx = 0.04285\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1535.4} = 1.550\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.06029\ \mathrm{in}, \qquad \max |\theta(x)| = 0.018530\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{612.3} = 3.887\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.03934\ \mathrm{in}, \qquad \max |\theta(x)| = 0.013931\ \mathrm{rad}\]
