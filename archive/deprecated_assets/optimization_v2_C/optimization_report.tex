...
\item Feasible designs found: 496
...
\item Maximum deflection: 0.09024 in
...
\[W = \rho \int_0^L A(x)\,dx = 0.02779\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1542.0} = 1.543\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.09024\ \mathrm{in}, \qquad \max |\theta(x)| = 0.035148\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{704.3} = 3.379\]
\[x_{FoS,min} = 2.490\ \mathrm{in}\]
\[\max |v(x)| = 0.05877\ \mathrm{in}, \qquad \max |\theta(x)| = 0.024872\ \mathrm{rad}\]
