...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 1.564 | 4.000 | 0.09504 | 1521.6 |
| Load Case 2 | side | 3.000 | 2.500 | 3.920 | 4.000 | 0.03857 | 607.2 |
...
- $$b(x)=\begin{cases}0.9752 + (-0.1563)x, & 0 \le x \le 4.0000\\0.3500 + (0.0725)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.5775 + (-0.0494)x, & 0 \le x \le 4.0000\\0.3800 + (0.0265)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.1558 + (0.0342)x, & 0 \le x \le 4.0000\\0.2924 + (0.0051)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.03578\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1521.6 = 1.564$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.09504\ \text{in}$
- $\max |\theta(x)| = 0.033566\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/607.2 = 3.920$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.03857\ \text{in}$
- $\max |\theta(x)| = 0.012755\ \text{rad}$
