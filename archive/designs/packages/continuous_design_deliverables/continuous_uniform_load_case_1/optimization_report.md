...
- Weight: 0.04212 lbf
- Minimum factor of safety: 1.601
- Excess FoS above target: 0.101
- Governing minimum-FoS load case: Load Case 2 at x = 4.000 in
- Maximum deflection: 0.12094 in
- Uniformity score toward FoS target (0 is best): 0.196401
- Symmetry score (0 is best): 0.000000
- Smoothness score (0 is best): 0.018208
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 1.732 | 4.000 | 0.12094 | 1374.3 |
| Load Case 2 | side | 8.000 | 5.000 | 1.601 | 4.000 | 0.10713 | 1486.3 |
...
- $$b(x)=\begin{cases}0.6903 + (-0.0734)x, & 0 \le x \le 4.0000\\0.3967 + (0.0734)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.3500 + (0.0000)x, & 0 \le x \le 4.0000\\0.3500 + (0.0000)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.04212\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1374.3 = 1.732$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.12094\ \text{in}$
- $\max |\theta(x)| = 0.043438\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1486.3 = 1.601$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.10713\ \text{in}$
- $\max |\theta(x)| = 0.038929\ \text{rad}$
