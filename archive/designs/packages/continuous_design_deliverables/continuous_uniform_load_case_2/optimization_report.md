...
- Uniformity score toward FoS target (0 is best): 0.134657
- Symmetry score (0 is best): 0.000000
- Smoothness score (0 is best): 0.017657
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 1.677 | 4.000 | 0.09685 | 1419.0 |
| Load Case 2 | side | 8.000 | 5.000 | 1.543 | 4.000 | 0.12117 | 1542.9 |
...
- $$b(x)=\begin{cases}0.5413 + (-0.0322)x, & 0 \le x \le 4.0000\\0.4126 + (0.0322)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.5765 + (-0.0538)x, & 0 \le x \le 4.0000\\0.3615 + (0.0538)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.03568\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1419.0 = 1.677$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.09685\ \text{in}$
- $\max |\theta(x)| = 0.032659\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1542.9 = 1.543$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.12117\ \text{in}$
- $\max |\theta(x)| = 0.045550\ \text{rad}$
