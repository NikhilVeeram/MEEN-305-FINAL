...
- Weight: 0.02124 lbf
- Minimum factor of safety: 1.635
- Excess FoS above target: 0.135
- Governing minimum-FoS load case: Load Case 2 at x = 5.500 in
- Maximum deflection: 0.12971 in
- Uniformity score toward FoS target (0 is best): 0.306228
- Symmetry score (0 is best): 0.000001
- Smoothness score (0 is best): 0.030758
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 3.574 | 4.500 | 0.03662 | 783.4 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.635 | 5.500 | 0.12971 | 1712.3 |
...
- $$b(x)=\begin{cases}0.2000 + (0.0535)x, & 0 \le x \le 4.5000\\0.4408 + (-0.0535)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.7736 + (-0.0365)x, & 0 \le x \le 4.5000\\0.6093 + (0.0365)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$r(x)=\begin{cases}0.5781 + (-0.0166)x, & 0 \le x \le 4.5000\\0.5035 + (0.0166)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $E_{eff} = E \times k_{orientation} \times k_{infill} = 500000.0 \times 0.700 \times 1.000 = 350000.0\ \text{psi}$
- $\sigma_{allow,eff} = \sigma_{allow} \times k_{orientation} \times k_{infill} = 4000.0 \times 0.700 \times 1.000 = 2800.0\ \text{psi}$
- Support positions: $x_A = 0.500\ \text{in}$, $x_B = 8.500\ \text{in}$
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.02124\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2800.0/783.4 = 3.574$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.03662\ \text{in}$
- $\max |\theta(x)| = 0.013620\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2800.0/1712.3 = 1.635$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.12971\ \text{in}$
- $\max |\theta(x)| = 0.061864\ \text{rad}$
