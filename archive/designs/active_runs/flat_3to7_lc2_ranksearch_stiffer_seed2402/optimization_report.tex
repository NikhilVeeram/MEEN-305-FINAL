...
\item Random seed: 2402
\end{itemize}

\section*{Best Design}
\begin{itemize}
\item Weight: 0.02824 lbf
...
\item Maximum deflection: 0.13739 in
\item Uniformity score toward FoS target (0 is best): 0.061571
\item Symmetry score (0 is best): 0.093298
\item Smoothness score (0 is best): 0.008265
...
\[W = \rho \int_0^{L_{total}} A(x)\,dx = 0.02824\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1115.0} = 2.135\]
\[x_{FoS,min} = 4.500\ \mathrm{in}\]
\[\max |v(x)| = 0.08365\ \mathrm{in}, \qquad \max |\theta(x)| = 0.033625\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1584.0} = 1.502\]
\[x_{FoS,min} = 5.500\ \mathrm{in}\]
\[\max |v(x)| = 0.13739\ \mathrm{in}, \qquad \max |\theta(x)| = 0.055160\ \mathrm{rad}\]
