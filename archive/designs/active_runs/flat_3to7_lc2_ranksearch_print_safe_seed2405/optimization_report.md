...
- Maximum allowed deflection: 0.15500 in
- Random seed: 2405

## Best Design

- Weight: 0.03141 lbf
- Minimum factor of safety: 1.544
- Excess FoS above target: 0.044
- Governing minimum-FoS load case: Load Case 2 at x = 5.500 in
- Maximum deflection: 0.15181 in
- Uniformity score toward FoS target (0 is best): 0.076704
- Symmetry score (0 is best): 0.134319
- Smoothness score (0 is best): 0.009603
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 3.285 | 4.500 | 0.03611 | 724.6 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.544 | 5.500 | 0.15181 | 1541.2 |
...
- $$b(x)=\begin{cases}0.2200 + (0.0347)x, & 0 \le x \le 4.5000\\0.3762 + (0.0072)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.8985 + (-0.0532)x, & 0 \le x \le 4.5000\\0.6590 + (0.0072)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$r(x)=\begin{cases}0.4303 + (-0.0952)x, & 0 \le x \le 4.5000\\0.0018 + (0.0623)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.03141\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/724.6 = 3.285$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.03611\ \text{in}$
- $\max |\theta(x)| = 0.013546\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1541.2 = 1.544$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.15181\ \text{in}$
- $\max |\theta(x)| = 0.059856\ \text{rad}$
