...
- Maximum allowed deflection: 0.16500 in
- Random seed: 2501

## Best Design

- Weight: 0.04743 lbf
- Minimum factor of safety: 1.519
- Excess FoS above target: 0.019
- Governing minimum-FoS load case: Load Case 2 at x = 5.500 in
- Maximum deflection: 0.14985 in
- Uniformity score toward FoS target (0 is best): 0.093358
- Symmetry score (0 is best): 0.373113
- Smoothness score (0 is best): 0.024558
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.04743\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/923.3 = 2.578$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.05260\ \text{in}$
- $\max |\theta(x)| = 0.020005\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1566.6 = 1.519$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.14985\ \text{in}$
- $\max |\theta(x)| = 0.062892\ \text{rad}$
