...
- Maximum deflection: 0.09271 in
- Uniformity score toward FoS target (0 is best): 0.495639
- Symmetry score (0 is best): 0.000001
- Smoothness score (0 is best): 0.028002
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 18.500 | 4.500 | 0.00438 | 128.6 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.501 | 5.500 | 0.09271 | 1585.1 |
...
- $$b(x)=\begin{cases}0.2866 + (0.0038)x, & 0 \le x \le 4.5000\\0.3037 + (-0.0038)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.6858 + (0.1814)x, & 0 \le x \le 4.5000\\1.5021 + (-0.1814)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$r(x)=\begin{cases}0.4909 + (0.0360)x, & 0 \le x \le 4.5000\\0.6527 + (-0.0360)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.06062\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/128.6 = 18.500$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.00438\ \text{in}$
- $\max |\theta(x)| = 0.001949\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1585.1 = 1.501$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.09271\ \text{in}$
- $\max |\theta(x)| = 0.041501\ \text{rad}$
