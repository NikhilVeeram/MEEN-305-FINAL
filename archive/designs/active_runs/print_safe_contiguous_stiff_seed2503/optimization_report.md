...
- Total evaluated designs: 1968
- Feasible designs found: 1305
...
- Weight: 0.04459 lbf
- Minimum factor of safety: 1.556
- Excess FoS above target: 0.056
- Governing minimum-FoS load case: Load Case 2 at x = 4.500 in
- Maximum deflection: 0.13946 in
- Uniformity score toward FoS target (0 is best): 0.124851
- Symmetry score (0 is best): 0.010584
- Smoothness score (0 is best): 0.017857
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 2.940 | 4.500 | 0.04040 | 809.7 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.556 | 4.500 | 0.13946 | 1529.5 |
...
- $$b(x)=\begin{cases}0.5897 + (-0.0609)x, & 0 \le x \le 4.5000\\0.3155 + (0.0482)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.7353 + (-0.0368)x, & 0 \le x \le 4.5000\\0.5698 + (0.0204)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$r(x)=\begin{cases}0.2000 + (-0.0012)x, & 0 \le x \le 4.5000\\0.1947 + (-0.0059)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.04459\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/809.7 = 2.940$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.04040\ \text{in}$
- $\max |\theta(x)| = 0.014485\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1529.5 = 1.556$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.13946\ \text{in}$
- $\max |\theta(x)| = 0.051857\ \text{rad}$
