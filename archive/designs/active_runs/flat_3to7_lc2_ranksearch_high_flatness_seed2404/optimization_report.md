...
- Weight: 0.02559 lbf
- Minimum factor of safety: 1.552
- Excess FoS above target: 0.052
- Governing minimum-FoS load case: Load Case 2 at x = 5.500 in
- Maximum deflection: 0.15237 in
- Uniformity score toward FoS target (0 is best): 0.063665
- Symmetry score (0 is best): 0.112076
- Smoothness score (0 is best): 0.011807
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 3.269 | 4.500 | 0.04394 | 728.1 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.552 | 5.500 | 0.15237 | 1533.0 |
...
- $$b(x)=\begin{cases}0.2080 + (0.0440)x, & 0 \le x \le 4.5000\\0.4059 + (-0.0148)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.5018 + (0.0314)x, & 0 \le x \le 4.5000\\0.6430 + (0.0295)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$r(x)=\begin{cases}0.3645 + (-0.0234)x, & 0 \le x \le 4.5000\\0.2592 + (0.0355)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.02559\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/728.1 = 3.269$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.04394\ \text{in}$
- $\max |\theta(x)| = 0.018951\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1533.0 = 1.552$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.15237\ \text{in}$
- $\max |\theta(x)| = 0.065753\ \text{rad}$
