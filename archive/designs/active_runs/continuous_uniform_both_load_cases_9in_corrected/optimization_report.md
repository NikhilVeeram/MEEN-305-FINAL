...
- Uniformity score toward FoS target (0 is best): 0.183257
- Symmetry score (0 is best): 0.000000
- Smoothness score (0 is best): 0.015549
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 3.464 | 4.500 | 0.03255 | 687.1 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.503 | 5.500 | 0.16121 | 1583.7 |
...
- $$b(x)=\begin{cases}0.5211 + (-0.0504)x, & 0 \le x \le 4.5000\\0.2943 + (0.0504)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.6585 + (0.0121)x, & 0 \le x \le 4.5000\\0.7128 + (-0.0121)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.04079\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/687.1 = 3.464$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.03255\ \text{in}$
- $\max |\theta(x)| = 0.012014\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1583.7 = 1.503$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.16121\ \text{in}$
- $\max |\theta(x)| = 0.059883\ \text{rad}$
