...
- Weight: 0.03059 lbf
- Minimum factor of safety: 1.513
- Excess FoS above target: 0.013
- Governing minimum-FoS load case: Load Case 2 at x = 5.500 in
- Maximum deflection: 0.14399 in
- Uniformity score toward FoS target (0 is best): 0.075849
- Symmetry score (0 is best): 0.000001
- Smoothness score (0 is best): 0.029530
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 2.968 | 4.500 | 0.04218 | 801.8 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.513 | 5.500 | 0.14399 | 1572.7 |
...
- $$b(x)=\begin{cases}0.2200 + (0.0487)x, & 0 \le x \le 4.5000\\0.4391 + (-0.0487)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.8573 + (-0.0628)x, & 0 \le x \le 4.5000\\0.5745 + (0.0628)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$r(x)=\begin{cases}0.1865 + (-0.0004)x, & 0 \le x \le 4.5000\\0.1846 + (0.0004)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.03059\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/801.8 = 2.968$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.04218\ \text{in}$
- $\max |\theta(x)| = 0.015102\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1572.7 = 1.513$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.14399\ \text{in}$
- $\max |\theta(x)| = 0.066296\ \text{rad}$
