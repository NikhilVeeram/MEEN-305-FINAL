...
- Weight: 0.01997 lbf
- Minimum factor of safety: 1.512
- Excess FoS above target: 0.012
- Governing minimum-FoS load case: Load Case 2 at x = 5.500 in
- Maximum deflection: 0.12337 in
- Uniformity score toward FoS target (0 is best): 0.294417
- Symmetry score (0 is best): 0.188328
- Smoothness score (0 is best): 0.015890
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 4.500 | 3.000 | 4.500 | 0.05305 | 793.4 |
| Load Case 2 | side | 8.000 | 5.000 | 5.500 | 1.512 | 5.500 | 0.12337 | 1574.4 |
...
- $$b(x)=\begin{cases}0.2267 + (0.0525)x, & 0 \le x \le 4.5000\\0.4629 + (0.0080)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$h(x)=\begin{cases}0.5450 + (0.0208)x, & 0 \le x \le 4.5000\\0.6384 + (-0.0633)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
- $$r(x)=\begin{cases}0.5392 + (0.0140)x, & 0 \le x \le 4.5000\\0.6022 + (-0.0274)(x-4.5000), & 4.5000 < x \le 9.0000\end{cases}$$
...
- $W = \rho \int_0^{L_{total}} A(x)\,dx = 0.01997\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/793.4 = 3.000$
- Governing location for this load case: $x = 4.500\ \text{in}$
- $\max |v(x)| = 0.05305\ \text{in}$
- $\max |\theta(x)| = 0.022348\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1574.4 = 1.512$
- Governing location for this load case: $x = 5.500\ \text{in}$
- $\max |v(x)| = 0.12337\ \text{in}$
- $\max |\theta(x)| = 0.052847\ \text{rad}$
