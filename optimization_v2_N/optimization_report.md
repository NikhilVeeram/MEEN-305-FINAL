...
- Weight: 0.03679 lbf
- Minimum factor of safety: 1.527
- Excess FoS above target: 0.027
- Governing minimum-FoS load case: Load Case 1 at x = 4.000 in
- Maximum deflection: 0.08237 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 1.527 | 4.000 | 0.08237 | 1558.2 |
| Load Case 2 | side | 3.000 | 2.500 | 3.903 | 4.000 | 0.03869 | 609.8 |
...
- $$b(x)=\begin{cases}0.7766 + (-0.1066)x, & 0 \le x \le 4.0000\\0.3500 + (0.0950)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}0.7165 + (-0.0866)x, & 0 \le x \le 4.0000\\0.3700 + (0.0822)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.2991 + (-0.0382)x, & 0 \le x \le 4.0000\\0.1462 + (0.1297)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.03679\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/1558.2 = 1.527$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.08237\ \text{in}$
- $\max |\theta(x)| = 0.026554\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/609.8 = 3.903$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.03869\ \text{in}$
- $\max |\theta(x)| = 0.013431\ \text{rad}$
