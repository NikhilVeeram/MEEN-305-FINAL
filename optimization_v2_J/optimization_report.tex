...
\section*{Best Design}
\begin{itemize}
\item Weight: 0.02655 lbf
\item Minimum factor of safety: 1.549
\item Excess FoS above target: 0.049
\item Governing minimum-FoS load case: Load Case 1 at $x=4.000$ in
\item Maximum deflection: 0.08478 in
...
\[W = \rho \int_0^L A(x)\,dx = 0.02655\ \mathrm{lbf}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{1536.6} = 1.549\]
\[x_{FoS,min} = 4.000\ \mathrm{in}\]
\[\max |v(x)| = 0.08478\ \mathrm{in}, \qquad \max |\theta(x)| = 0.027722\ \mathrm{rad}\]
...
\[FoS_{min} = \frac{\sigma_{allow,eff}}{\sigma_{vm,max}} = \frac{2380.0}{661.6} = 3.598\]
\[x_{FoS,min} = 2.490\ \mathrm{in}\]
\[\max |v(x)| = 0.06091\ \mathrm{in}, \qquad \max |\theta(x)| = 0.025554\ \mathrm{rad}\]
