...
def build_geometry_from_variables(
    ...
    return TaperedRectangularTube(
        ...
        right_width_in=variables["right_width_in"],
        left_height_in=variables["left_height_in"],
        mid_height_in=variables["mid_height_in"],
        right_height_in=variables["right_height_in"],
        ...
        right_web_opening_ratio=variables["right_web_opening_ratio"],
    )
...
def run_search(
    ...
    for sample in latin_hypercube_samples(bounds, search_config.initial_samples, rng):
        geometry = build_geometry_from_variables(sample, span_in, total_length_in)
        evaluations.append(
                    evaluate_design(
                        evaluation_id=evaluation_id,
                        geometry=geometry,
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="optimization_outputs")
