...
- Weight: 0.07581 lbf
- Minimum factor of safety: 17.286
- Governing minimum-FoS load case: Load Case 1 at x = 4.000 in
- Maximum deflection: 0.00300 in
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Load Case 1 | upright | 5.000 | 4.000 | 17.286 | 4.000 | 0.00300 | 137.7 |
| Load Case 2 | side | 3.000 | 2.500 | 25.548 | 2.490 | 0.00270 | 93.2 |
...
- $$b(x)=\begin{cases}1.3474 + (-0.1457)x, & 0 \le x \le 4.0000\\0.7646 + (-0.0133)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$h(x)=\begin{cases}1.2732 + (0.0042)x, & 0 \le x \le 4.0000\\1.2902 + (-0.0265)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
- $$r(x)=\begin{cases}0.5575 + (0.0356)x, & 0 \le x \le 4.0000\\0.7000 + (-0.0466)(x-4.0000), & 4.0000 < x \le 8.0000\end{cases}$$
...
- $W = \rho \int_0^L A(x)\,dx = 0.07581\ \text{lbf}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/137.7 = 17.286$
- Governing location for this load case: $x = 4.000\ \text{in}$
- $\max |v(x)| = 0.00300\ \text{in}$
- $\max |\theta(x)| = 0.001176\ \text{rad}$
...
- $FoS_{min} = \sigma_{allow,eff}/\sigma_{vm,max} = 2380.0/93.2 = 25.548$
- Governing location for this load case: $x = 2.490\ \text{in}$
- $\max |v(x)| = 0.00270\ \text{in}$
- $\max |\theta(x)| = 0.001032\ \text{rad}$
